# Architecture Decision Record - Dashboard KPI calculator service
...
Implement Dashboard KPI calculator service using industry-standard patterns appropriate for nodejs and our platform requirements.
