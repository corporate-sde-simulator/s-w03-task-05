...
> **Welcome to Service-Track Week 3, Task 5!**
...
| `src/kpiCalculator.js` | Supporting code - **may also have bugs** |
| `tests/kpiCalculator.test.js` | Test file - **add your tests here** |
